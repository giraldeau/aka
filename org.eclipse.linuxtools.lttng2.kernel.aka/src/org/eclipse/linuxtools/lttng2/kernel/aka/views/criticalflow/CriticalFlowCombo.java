...
public class CriticalFlowCombo extends Composite {
	     ...
	     */
	    public CriticalFlowCombo(Composite parent, int style) {
	        super(parent, style);
	        ...
	        fTimeGraphViewer = new CriticalFlowViewer(sash, SWT.NONE);
